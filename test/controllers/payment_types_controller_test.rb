...
class PaymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post payment_types_url, params: { payment_type: { account_number: @payment_type.account_number, company_id: @payment_type.company_id, payment_type: @payment_type.payment_type } }, as: :json
    end
  ...
  test "should update payment_type" do
    patch payment_type_url(@payment_type), params: { payment_type: { account_number: @payment_type.account_number, company_id: @payment_type.company_id, payment_type: @payment_type.payment_type } }, as: :json
    assert_response 200
  end
